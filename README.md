...
StreetPack stores optional outputs/receipts under a user data home (platform-specific). Exact paths may vary by environment and will be documented further as the project evolves.
